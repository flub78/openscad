...
function getBlocks(tolerance = 0) = let(zSD = - pcbThickness - (1.8 + tolerance) / 2 ) [
    ...
    [ [ 15.0 + tolerance, 11.50 + tolerance,  6.3 + tolerance ], "Cyan",          [ 32.00,  4.55,  0.0 ],      0 ], // 5 HDMI
    [ [ 14.6 + tolerance, 14.60 + tolerance,  1.8 + tolerance ], "Purple",        [  7.30, 28.80,  zSD ],      0 ], // 6 Micro SD
    [ [  7.5 + tolerance,  5.80 + tolerance,  3.1 + tolerance ], "Silver",        [ 10.60,  1.40,  0.0 ],      0 ], // 7 Micro USB
